...
class Activity(Page, Ownable):
    categories = models.ManyToManyField("LCOCategory",
                                        verbose_name=_("Categories"),
                                        blank=True, related_name="activity_category")
...
class Seminar(Page):
    categories = models.ManyToManyField("LCOCategory",
                                        verbose_name=_("Categories"),
                                        blank=True, related_name="seminar_category")
...
class Profile(models.Model, AdminThumbMixin):
    ...
    categories = models.ManyToManyField("LCOCategory",
                                        verbose_name=_("Categories"),
                                        blank=True, related_name="person_category")
