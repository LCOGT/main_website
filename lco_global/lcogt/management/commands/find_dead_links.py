...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.set_defaults(page=False,full=False, blog=False, url="http://lco.global")
    ...
    def handle(self, **options):
        ...
        if full or page:
            ...
            pages = Page.objects.filter(status=2)
    ...
    def test_link(self, path, referrer):
        ...
        if req.status_code != 200:
            logger.error('{} gave code {} on {}'.format(path, req.status_code,referrer.slug))
            return
        return
