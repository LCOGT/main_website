...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LCOPage.no_side_block'
        db.add_column(u'lcogt_lcopage', 'no_side_block',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LCOPage.no_side_block'
        db.delete_column(u'lcogt_lcopage', 'no_side_block')
