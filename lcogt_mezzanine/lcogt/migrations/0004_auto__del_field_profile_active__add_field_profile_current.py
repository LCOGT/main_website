...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'lcogt_profile', 'active')

        # Adding field 'Profile.current'
        db.add_column(u'lcogt_profile', 'current',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'lcogt_profile', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Profile.current'
        db.delete_column(u'lcogt_profile', 'current')
    ...
    models = {
        ...
        u'lcogt.seminar': {
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'seminardate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 8, 0, 0)'}),
